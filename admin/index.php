...
<div class="clearfix"></div>
      ...
      <div class="container-fluid bg-dark text-light footer pt-0 mt-0 wow fadeIn" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
         <div class="container py-5 text-bottom-footer">
            ...
            <div class="row mt-5">
               ...
               <div class="col-lg-4 col-md-6">
                  <div class="rounded float-lg-end clearfix"><img class="img-fluid" src="<?php echo BASE_URL.'/images/app.png' ?>"></div>
                  <div class="clearfix"></div>
                  <div class="rounded float-lg-end clearfix mt-1"><img class="img-fluid" src="<?php echo BASE_URL.'/images/google.jpg' ?>"></div>
               </div>
            </div>
         </div>
      </div>
      ...
      <!-- restaurnat Switch modal -->
      <!-- The Modal -->
      <div id="hoteladdpopupbox" class="modal eAZySs">
         <!-- Modal content -->
         <div class="exMoeW">
