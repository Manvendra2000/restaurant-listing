...
function generateRestaurantTile(restaurant, lat, lng, container = 'restaurantlisting') {
    const {
        name = "",
        avgRating = "",
        sla = {},
...
<div class="sc-6065b21f-14 fXeQrN">
 <span class="fRCMLg">${Array.isArray(cuisines) && cuisines.length ? cuisines.join(' ,') : ''
        }</span >
 <span class="fRCMLg">${areaName || ''}</span>
    ...
    `
    $(`#${container} `).append(restaurantTileHtml);
}
