...
<header data-testid="Header" class="cUNlxH d-md-none">
	<div class="bzAKfa">
		<div class="gbAjIQ">
			...
			<a href="<?php echo  BASE_URL ?>" ><img class="" src="../images/logo.gif" alt="Jio Reliance Logo" style="width: 125px; margin-right: -20px;"/>    </a>
...
<!--                    
					...
					<img class="" src="../images/logo.gif" alt="Jio Reliance Logo" style="width: 125px; margin-right: -20px;"/>                
      </a>
      <!-- Search form -->
